...
// added by rgrp
// standard latex blocks. want to allow them so that we can easily convert to
// real latex
{input:"\\[",	tag:"mi", output:"", ttype:CONST},
{input:"\\]",	tag:"mi", output:"", ttype:CONST},
  ...
  if (n.childNodes.length == 0) {
   if ((n.nodeType!=8 || linebreaks) &&
    ...
    if (!(str == null)) {
      ...
      str = str.replace(/\s*\r\n/g," ");
// DELIMITERS:
      mtch = (str.indexOf(AMdelimiter1)==-1 ? false : true);
      // str = str.replace(/([^\\])\$/g,"$1 \$");
...
// DELIMITERS:
    if (st==null || st.indexOf(AMdelimiter1)!=-1)
